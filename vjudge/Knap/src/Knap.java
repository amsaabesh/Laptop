...
final class Knap{
    ...
    private final int generation_counter = 1;
    ...
    private final ArrayList<Integer> weight = new ArrayList<>();
    private final ArrayList<Double> fitness = new ArrayList<>();
    private final ArrayList<Double> generation_fitness = new ArrayList<>();
    private final ArrayList<String> population = new ArrayList<>();
    private final ArrayList<String> next_gen = new ArrayList<>();
    private final ArrayList<String> generation_solution = new ArrayList<>();
